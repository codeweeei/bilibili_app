  ...
  <div class="home">
    ...
    <div class="acticle" v-if="model">
      ...
      <div class="acticle_title">
        ...
        <div class="right">
          <img
            src="@/assets/more.svg"
            alt
            @click="foldheight = foldheight == 0 ? 20 : 0"
            :class="{ spread: foldheight }"
          />
        </div>
      </div>
      ...
      <div class="acticle_icon">
        <div
          @click="collectClick"
          :class="{ collectActive: iscollectActive }"
        >
          <span class="icon-star-full"></span>收藏
        </div>
      ...
      <van-tabs v-model="active" animated>
        ...
        <van-tab title="评论">
          ...
          <div style="width:100%">
            <comment
              @getcomlen="(res) => (commentlenth = res)"
              @answerid="answerid"
              ref="commentupdata"
            />
          </div>
